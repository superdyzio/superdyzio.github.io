  ...
  return (
    <div className="space-y-16">
      <header className="space-y-4">
        <h1 className="text-4xl font-extrabold tracking-tight lg:text-5xl text-gray-900">Experience</h1>
          ...
          <div key={index} className="relative pl-8 before:absolute before:left-0 before:top-0 before:bottom-0 before:w-px before:bg-gray-200 last:before:bottom-8">
            ...
            <div className="space-y-4">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
                ...
                <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-gray-100 text-gray-800 self-start md:self-center">
                  {exp.period}
                </span>
              </div>
      ...
      <div className="pt-12 border-t text-center space-y-8">
        ...
        <div className="flex justify-center gap-4">
          <a 
            href="/contact" 
            className="px-8 py-4 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-700 transition-all shadow-md hover:shadow-lg"
          >
            Get in touch
          </a>
          <a 
            href="/offer" 
            className="px-8 py-4 border border-gray-300 text-gray-700 font-bold rounded-xl hover:bg-gray-50 transition-all shadow-sm"
          >
            See my services
          </a>
        </div>
